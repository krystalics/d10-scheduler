...
package com.github.krystalics.d10.scheduler.rpc.utils;
...
public class NetUtils {
     ...
     */
    public static final String D10_SCHEDULER_NETWORK_INTERFACE_PREFERRED = "d10.scheduler.network.interface.preferred";

    /**
     * network IP gets priority, default inner outer
     */
    public static final String D10_SCHEDULER_NETWORK_PRIORITY_STRATEGY = "d10.scheduler.network.priority.strategy";
    ...
    public static String getHost() {
        ...
        return KUBERNETES_MODE ? "localhost" : "127.0.0.1";
    }
    ...
    private static boolean isSpecifyNetworkInterface(NetworkInterface networkInterface) {
        String preferredNetworkInterface = PropertyUtils.getString(D10_SCHEDULER_NETWORK_INTERFACE_PREFERRED,
                System.getProperty(D10_SCHEDULER_NETWORK_INTERFACE_PREFERRED));
    ...
    private static NetworkInterface findAddress(List<NetworkInterface> validNetworkInterfaces) {
        ...
        String networkPriority = PropertyUtils.getString(D10_SCHEDULER_NETWORK_PRIORITY_STRATEGY, NETWORK_PRIORITY_DEFAULT);
