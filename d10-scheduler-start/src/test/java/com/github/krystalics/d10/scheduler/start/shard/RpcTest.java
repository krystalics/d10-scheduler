...
package com.github.krystalics.d10.scheduler.start.shard;
...
public class RpcTest {
    ...
    public void sendTest() throws Exception {
        ...
        IRebalanceService rebalanceService = rpcClient.create(IRebalanceService.class, host);

        JobInstance instance = new JobInstance();

        rebalanceService.shardBegin(instance);
