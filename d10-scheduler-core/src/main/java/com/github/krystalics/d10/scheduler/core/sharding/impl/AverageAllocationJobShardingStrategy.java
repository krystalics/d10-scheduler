...
package com.github.krystalics.d10.scheduler.core.sharding.impl;


import com.github.krystalics.d10.scheduler.core.common.JobInstance;
import com.github.krystalics.d10.scheduler.core.sharding.ShardingStrategy;
 ...
 * </p>
 */
public final class AverageAllocationJobShardingStrategy implements ShardingStrategy {
    
    @Override
    public Map<JobInstance, List<Integer>> sharding(final List<JobInstance> jobInstances, final int shardingTotalCount) {
